 ...
 *
 *
 * Inicializar Un Objeto de esta clase, Crea una nueva JTABLE Se le añade el
 * JTABLEMODEL correspondiente AQUI y setea los colores,tamaños(propiedades) de
 * la tabla.
 *
 * Llamar al metodo "getJtable para setearle ESTA JTABLE a la JTABLE de la
 * VISTA"
 *
 * ////////////////////////////////////////////////////////////////////////////////
 *
 ...
 * ---------METODOS PRIVADOS------
 *
 * setJtableHeaders() =======> Metodo en el que se EDITAN LOS HeaderS(TITULOS)
 * de la JTABLE (Se PINTA el Background y foreground de los HEADERS, y AQUI le
 * INDICAMOS que LAS COLUMNAS NO PUEDAN MOVERSE(reordenarse))
 *
 * initDefaultTableModel() ===> Metodo que inicializa el "modelo" de la tabla
 * (en este BLOQUEAMOS LA EDICION de las celdas,)
 *
 *
 */
public class TableModelPaint {
    ...
    /**
     * AÑADIENDO LOS "JTableModels" para las tablas de la vista aquí LOS DEJO
     * PARA VERLOS Y SABER QUE VAN AQUÍ, Porque estos definidos nose utilizan,
...
//        this.tableModelGuerra = tableModelGuerra;
    ...
    /**
     * Este Metodo, RECIBE un "Object" que deberá ser un "AbstracTableModel" o
     * cambiar a "TableModel" Será el JTableModel que queramos establecerle a
     * nuestra JTABLE.
     *
     * @param tableModel
     *
...
//                }
        ...
        //Seteando que puedan ser seleccionadas las celdas
        ...
        //Alineando texto de la celda(arriba,abajo) en este caso es en el CENTRO
...
//////Estableciendo TAMAÑO DE COLUMNAS, SEGUN LA LENGTH DEL ARRAY RECIBIDO\\\\\\\\\\\
...
/////////Alineando el texto (a izquierda,derecha) en este caso CENTRADO
